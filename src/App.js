        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col l3 s12">
              ...
              <ul>
                <li><a className="white-text" href="/home">Link 1</a></li>
                <li><a className="white-text" href="/home">Link 2</a></li>
                <li><a className="white-text" href="/home">Link 3</a></li>
                <li><a className="white-text" href="/home">Link 4</a></li>
              </ul>
            </div>
            <div className="col l3 s12">
